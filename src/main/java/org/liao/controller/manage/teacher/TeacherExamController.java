...
public class TeacherExamController {
    ...
    public ModelAndView edit(@PathVariable("id") Integer id) {
        ...
        List<ExamQuestionDifficulty> difficulty = difficultyService.list();
    ...
    public String importQuestion(HttpServletRequest request,
        ...
        c[1] = '8';
        if (c[0] >= '1' && c[0] <= '9')
            TeacherExamController.currentWeek = String.valueOf(c[0]) + String.valueOf(c[1]);
        else
            TeacherExamController.currentWeek = String.valueOf(c[1]);
    ...
    public void save(@RequestParam("file") MultipartFile file,
        ...
        if (!file.getOriginalFilename().equals("")) {
            ...
            for (int i = 1; i <= rownum; i++) {
                ...
                ExamQuestionDifficulty difficulty = difficultyService.findByDifficultyByName(data.get(12));
